...
const faqData = [
  {
    ...
    answer:
      "Most of our game top-ups are delivered instantly (within 1-5 minutes). Some products may take up to 30 minutes depending on the game server and region. You'll see the estimated delivery time on each product page.",
  ...
  {
    question: "Do you support all regions?",
    answer:
      "We support game top-ups for most regions worldwide including Global, SEA, Brazil, Russia, Philippines, India, and many more. Each product page shows the supported regions for that specific game.",
    icon: "mdi:earth",
  },
];
