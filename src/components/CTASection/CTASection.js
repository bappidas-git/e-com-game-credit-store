...
const CTASection = () => {
  ...
  const stats = [
    ...
    { value: "100+", label: "Games Supported", icon: "mdi:gamepad-variant" },
    { value: "24/7", label: "Customer Support", icon: "mdi:headset" },
    { value: "99.9%", label: "Delivery Success", icon: "mdi:check-circle" },
  ];
      ...
      <Container maxWidth="lg" className={styles.container}>
        ...
        >
          <Typography variant="h2" className={styles.title}>
            Ready to Level Up{" "}
            <span className={styles.titleHighlight}>Your Gaming?</span>
          </Typography>
          <Typography className={styles.description}>
            Join thousands of gamers who trust us for fast, secure, and reliable
            game top-ups. Get started in seconds and enjoy instant delivery!
          </Typography>
