  ...
  const sections = [
    {
      ...
      content: [
        {
          text: "By accessing or using KELLS GLOBAL's website and services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing our services."
        },
        {
    ...
    },
    {
      ...
      content: [
        {
          text: "KELLS GLOBAL provides digital gaming products including game credits, in-game currency, gift cards, and subscription codes. By purchasing our products, you acknowledge that:"
        },
        {
          list: [
    ...
    },
    {
      ...
      content: [
        {
          text: "All content on our website, including text, graphics, logos, images, and software, is the property of KELLS GLOBAL or its licensors and is protected by copyright and other intellectual property laws."
        },
        {
    ...
    },
    {
      ...
      content: [
        {
          text: "To the maximum extent permitted by law, KELLS GLOBAL shall not be liable for:"
        },
        {
          list: [
    ...
    },
    {
      ...
      content: [
        {
          text: "You agree to indemnify and hold harmless KELLS GLOBAL, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses arising from your use of our services, violation of these terms, or infringement of any third-party rights."
        }
      ]
    },
    {
            ...
            >
              ...
              <Box className={styles.introduction}>
                <Typography variant="body1">
                  Welcome to KELLS GLOBAL. These Terms of Service ("Terms") govern your use of our website and services. Please read these terms carefully before using our platform.
                </Typography>
              </Box>
