  ...
  const sections = [
    {
      ...
      content: [
        {
          text: "At KELLS GLOBAL, we strive to provide high-quality digital gaming products and excellent customer service. Due to the digital nature of our products, our refund policy differs from traditional retail. Please read this policy carefully before making a purchase."
        }
      ]
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          list: [
            "You provided incorrect account information (player ID, email, etc.)",
    ...
    },
    {
      ...
      content: [
        ...
        {
          text: "Email: support@kellsglobal.com\nResponse Time: Within 24 hours"
        }
      ]
    }
  ];
