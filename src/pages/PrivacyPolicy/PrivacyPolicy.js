  ...
  const sections = [
      ...
      content: [
        {
          ...
          text: "When you create an account or make a purchase, we collect information such as your name, email address, phone number, billing address, and payment information. We also collect your game account details (player IDs) necessary to deliver your purchased products."
        },
        {
    ...
    },
    {
      ...
      content: [
        ...
        {
          text: "To exercise these rights, please contact us at privacy@kellsglobal.com"
        }
      ]
    },
    {
            ...
            >
              ...
              <Box className={styles.introduction}>
                <Typography variant="body1">
                  Welcome to KELLS GLOBAL. We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
                </Typography>
                <Typography variant="body1">
