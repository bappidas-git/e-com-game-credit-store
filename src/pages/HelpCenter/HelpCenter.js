...
const HelpCenter = () => {
  ...
  const helpCategories = [
    ...
    },
    {
      ...
      description: "How to receive and use your digital products",
      faqs: [
        {
          question: "How will I receive my digital product?",
          answer: "Digital products are delivered directly to your game account using the player ID you provide, or sent to your email for codes and gift cards."
        },
        {
          question: "What if I entered the wrong player ID?",
          answer: "Please double-check your player ID before purchase. If you entered incorrect information, contact support immediately. We may not be able to reverse completed deliveries."
        },
        {
          question: "How do I redeem a gift card code?",
          answer: "Gift card codes can be redeemed on the respective platform (Steam, PlayStation, Xbox, etc.). Go to the store's 'Redeem Code' section and enter your code."
        },
        {
          question: "My top-up didn't appear in my game account",
          answer: "Please wait up to 30 minutes for processing. If the issue persists, contact support with your order number and player ID."
        },
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "We offer game credits, in-game currency top-ups, gift cards, subscriptions, and digital codes for various gaming platforms."
        },
        {
            ...
            <Grid item xs={12} sm={4}>
              <Card className={styles.contactCard}>
                <CardContent className={styles.contactCardContent}>
                  ...
                  <Typography variant="body2">support@kellsglobal.com</Typography>
