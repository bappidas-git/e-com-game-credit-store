                  ...
                  >
                    ...
                    >
                      ...
                      <Box className={styles.badges}>
                        ...
                        {item.offers && getProductMaxDiscount({ offers: item.offers }) > 0 && (
                          <Chip
                            label={`-${getProductMaxDiscount({ offers: item.offers })}%`}
                            size="small"
                        ...
                        <Box className={styles.priceSection}>
                          <Typography variant="h6" className={styles.price}>
                            {item.offers && item.offers.length > 0
                              ? `From ${formatCurrency(getProductMinPrice({ offers: item.offers }).sellingPrice, "INR")}`
                              : "View Prices"}
                          </Typography>
                          <IconButton
                            size="small"
